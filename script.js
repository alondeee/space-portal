...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function handleDownload() {
    ...
    const url =
      currentAPOD.hdurl || currentAPOD.url || currentAPOD.thumbnail_url;
  ...
  function showDemoAPOD() {
    const demoData = {
      ...
      explanation:
        "What does the Andromeda galaxy look like in ultraviolet light? Young blue stars circle the galactic center in this image from NASA's Swift satellite. The Andromeda Galaxy, also known as M31, is the closest major galaxy to our own Milky Way.",
